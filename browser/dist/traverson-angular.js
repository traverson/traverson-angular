...
},{"../third-party/superagent":9}],7:[function(_dereq_,module,exports){
'use strict';
...
},{"resolve-url":23}],9:[function(_dereq_,module,exports){
;(function(){
...
},{"emitter":1,"indexof":1,"reduce":1,"superagent":1}],10:[function(_dereq_,module,exports){
'use strict';
...
},{"./final_action":11,"./media_type_registry":14,"./media_types":15,"./walker":17,"minilog":4,"request":6,"util":5}],11:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4}],12:[function(_dereq_,module,exports){
'use strict';
...
function JsonAdapter(contentNegotiation) {
...
},{"JSONPath":18,"minilog":4,"underscore.string":7}],13:[function(_dereq_,module,exports){
'use strict';
...
function JsonHalAdapter(contentNegotiation) {
  this.contentNegotiation = contentNegotiation;
}
...
},{"halfred":19,"minilog":4,"underscore.string":7}],14:[function(_dereq_,module,exports){
'use strict';
...
exports.register(mediaTypes.JSON_HAL, _dereq_('./json_hal_adapter'));

},{"./json_adapter":12,"./json_hal_adapter":13,"./media_types":15,"./negotiation_adapter":16}],15:[function(_dereq_,module,exports){
'use strict';
...
var JsonAdapter = _dereq_('./json_adapter')
  , mediaTypeRegistry = _dereq_('./media_type_registry');

var log = minilog('traverson');

function Walker(adapter) {
  this.adapter = adapter || new JsonAdapter();
}
...
Walker.prototype.get = function(step, callback) {
  ...
  this.request.get(step.uri, function(err, response, body) {
    ...
    if (self.adapter.contentNegotiation &&
      ...
      self.adapter = new AdapterType(self.adapter.contentNegotiation);
    }
...
},{"./json_adapter":12,"./media_type_registry":14,"minilog":4,"underscore.string":7,"url":8,"url-template":24,"util":5}],18:[function(_dereq_,module,exports){
...
},{"vm":2}],19:[function(_dereq_,module,exports){
...
},{"./lib/parser":21}],20:[function(_dereq_,module,exports){
'use strict';
...
},{"./immutable_stack":20,"./resource":22}],22:[function(_dereq_,module,exports){
'use strict';
...
},{"./lib/builder":10,"./lib/media_types":15,"minilog":4}],26:[function(_dereq_,module,exports){
/* global angular */
'use strict';

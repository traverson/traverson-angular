...
},{"superagent":43}],8:[function(_dereq_,module,exports){
'use strict';
...
},{"resolve-url":42}],10:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5}],11:[function(_dereq_,module,exports){
'use strict';

var minilog = _dereq_('minilog')
  , log = minilog('traverson')
  , abortTraversal = _dereq_('./abort_traversal')
  , applyTransforms = _dereq_('./transforms/apply_transforms')
  , httpRequests = _dereq_('./http_requests')
  , isContinuation = _dereq_('./is_continuation')
  , walker = _dereq_('./walker');

var checkHttpStatus = _dereq_('./transforms/check_http_status')
  , continuationToDoc =
      _dereq_('./transforms/continuation_to_doc')
  , continuationToResponse =
      _dereq_('./transforms/continuation_to_response')
  , convertEmbeddedDocToResponse =
      _dereq_('./transforms/convert_embedded_doc_to_response')
  , extractDoc =  _dereq_('./transforms/extract_doc')
  , extractResponse =  _dereq_('./transforms/extract_response')
  , extractUrl =  _dereq_('./transforms/extract_url')
  , fetchLastResource =  _dereq_('./transforms/fetch_last_resource')
  , executeLastHttpRequest = _dereq_('./transforms/execute_last_http_request')
  , executeHttpRequest = _dereq_('./transforms/execute_http_request')
...
},{"./abort_traversal":10,"./http_requests":13,"./is_continuation":14,"./transforms/apply_transforms":20,"./transforms/check_http_status":21,"./transforms/continuation_to_doc":22,"./transforms/continuation_to_response":23,"./transforms/convert_embedded_doc_to_response":24,"./transforms/execute_http_request":26,"./transforms/execute_last_http_request":27,"./transforms/extract_doc":28,"./transforms/extract_response":29,"./transforms/extract_url":30,"./transforms/fetch_last_resource":31,"./transforms/parse":34,"./walker":40,"minilog":5}],12:[function(_dereq_,module,exports){
'use strict';
...
},{"./abort_traversal":10,"./actions":11,"./media_type_registry":16,"./media_types":17,"./merge_recursive":18,"minilog":5,"request":7,"util":6}],13:[function(_dereq_,module,exports){
(function (process){
'use strict';
var minilog = _dereq_('minilog')
  , log = minilog('traverson')
...
},{"./abort_traversal":10,"./transforms/detect_content_type":25,"./transforms/get_options_for_step":33,"JkpR2F":2,"minilog":5}],14:[function(_dereq_,module,exports){
'use strict';
...
var jsonpath = _dereq_('jsonpath-plus')
...
},{"jsonpath-plus":41,"minilog":5,"underscore.string":8}],16:[function(_dereq_,module,exports){
'use strict';
...
},{"./json_adapter":15,"./media_types":17,"./negotiation_adapter":19}],17:[function(_dereq_,module,exports){
'use strict';
...
},{"JkpR2F":2,"minilog":5}],21:[function(_dereq_,module,exports){
'use strict';
...
},{"../is_continuation":14,"minilog":5}],22:[function(_dereq_,module,exports){
'use strict';
...
},{"../is_continuation":14,"minilog":5}],23:[function(_dereq_,module,exports){
'use strict';

var minilog = _dereq_('minilog')
  , log = minilog('traverson')
  , convertEmbeddedDocToResponse =
      _dereq_('./convert_embedded_doc_to_response')
  , isContinuation = _dereq_('../is_continuation');
...
},{"../is_continuation":14,"./convert_embedded_doc_to_response":24,"minilog":5}],24:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5}],25:[function(_dereq_,module,exports){
'use strict';
...
},{"../media_type_registry":16,"minilog":5}],26:[function(_dereq_,module,exports){
'use strict';
...
},{"../abort_traversal":10,"../http_requests":13,"minilog":5}],27:[function(_dereq_,module,exports){
'use strict';
...
},{"../abort_traversal":10,"../http_requests":13,"minilog":5}],28:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5}],29:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5}],30:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5,"url":9}],31:[function(_dereq_,module,exports){
'use strict';
...
},{"../abort_traversal":10,"../http_requests":13,"minilog":5}],32:[function(_dereq_,module,exports){
(function (process){
'use strict';
...
},{"../abort_traversal":10,"../http_requests":13,"../is_continuation":14,"JkpR2F":2,"minilog":5}],33:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5,"util":6}],34:[function(_dereq_,module,exports){
'use strict';
...
},{"../is_continuation":14,"minilog":5}],35:[function(_dereq_,module,exports){
'use strict';

var isContinuation = _dereq_('../is_continuation');
...
},{"../is_continuation":14}],36:[function(_dereq_,module,exports){
'use strict';
...
},{"../is_continuation":14}],37:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5,"underscore.string":8,"url":9}],38:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5,"underscore.string":8,"url-template":46,"util":6}],39:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":5}],40:[function(_dereq_,module,exports){
'use strict';
...
var transforms = [
  _dereq_('./transforms/fetch_resource'),
  _dereq_('./transforms/reset_last_step'),
  // check HTTP status code
  _dereq_('./transforms/check_http_status'),
  // parse JSON from last response
  _dereq_('./transforms/parse'),
  // retrieve next link and switch to next step
  _dereq_('./transforms/switch_to_next_step'),
  ...
  // encode curly braces.
  resolveUriTemplate,
  _dereq_('./transforms/resolve_next_url'),
  _dereq_('./transforms/reset_continuation'),
];
...
},{"./abort_traversal":10,"./is_continuation":14,"./transforms/apply_transforms":20,"./transforms/check_http_status":21,"./transforms/fetch_resource":32,"./transforms/parse":34,"./transforms/reset_continuation":35,"./transforms/reset_last_step":36,"./transforms/resolve_next_url":37,"./transforms/resolve_uri_template":38,"./transforms/switch_to_next_step":39,"minilog":5}],41:[function(_dereq_,module,exports){
...
}(typeof _dereq_ === 'undefined' ? null : _dereq_));

},{"vm":3}],42:[function(_dereq_,module,exports){
...
},{"./lib/builder":12,"./lib/media_type_registry":16,"./lib/media_types":17,"JkpR2F":2,"minilog":5}],48:[function(_dereq_,module,exports){
/* global angular */
'use strict';
